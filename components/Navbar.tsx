...
import UnreadMessageCounter from "./UnreadMessageCount";
      ...
      {isMobileMenuOpen && (
        <div id='mobile-menu'>
          <div className='space-y-1 px-2 pb-3 pt-2'>
            <Link href='/' className={`${pathname === "/" ? "bg-black" : ""} 'bg-black text-white block rounded-md px-3 py-2 text-base font-medium'`}>
              Home
            </Link>
